...
xy_train = train_datagen.flow_from_directory(
    '../data/image/male_female/male_female',
    target_size=(224,224),
    batch_size=1736,
    class_mode='binary',
    subset='training'
...
np.save('../data/image/brain/npy/k67_train_x__.npy', arr=xy_train[0][0])
np.save('../data/image/brain/npy/k67_train_y__.npy', arr=xy_train[0][1])
#np.save('../data/image/brain/npy/k67_val_x__.npy', arr=xy_val[0][0])
#np.save('../data/image/brain/npy/k67_val_y__.npy', arr=xy_val[0][1])

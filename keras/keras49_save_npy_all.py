...
np.save('../data/npy/fmnist_x_train.npy',arr=fmnist_x_train)
np.save('../data/npy/fmnist_x_test.npy',arr=fmnist_x_test)
np.save('../data/npy/fmnist_y_train.npy',arr=fmnist_y_train)
np.save('../data/npy/fmnist_y_test.npy',arr=fmnist_y_test)
# 8.cifar10

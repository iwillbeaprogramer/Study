...
model=Sequential()
model.add(Conv1D(filters = 128,kernel_size=2,input_shape = (x_train.shape[1],x_train.shape[2])))
...
conv1d
loss :  [4705.18017578125, 52.632301330566406]
rmse :  68.59431493753274
R2 :  0.016247741590565634
'''
